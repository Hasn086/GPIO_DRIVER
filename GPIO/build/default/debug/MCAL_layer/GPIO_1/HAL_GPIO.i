# 1 "MCAL_layer/GPIO_1/HAL_GPIO.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_layer/GPIO_1/HAL_GPIO.c" 2
# 1 "MCAL_layer/GPIO_1/HAL_GPIOI.h" 1
# 11 "MCAL_layer/GPIO_1/HAL_GPIOI.h"
...
# 11 "MCAL_layer/GPIO_1/HAL_GPIOI.h" 2



# 1 "MCAL_layer/GPIO_1/../mcal_std_types.h" 1
# 11 "MCAL_layer/GPIO_1/../mcal_std_types.h"
# 1 "MCAL_layer/GPIO_1/../std_libraries.h" 1
# 11 "MCAL_layer/GPIO_1/../std_libraries.h"
...
# 11 "MCAL_layer/GPIO_1/../std_libraries.h" 2
# 11 "MCAL_layer/GPIO_1/../mcal_std_types.h" 2

# 1 "MCAL_layer/GPIO_1/../compiler.h" 1
# 12 "MCAL_layer/GPIO_1/../mcal_std_types.h" 2
...
# 14 "MCAL_layer/GPIO_1/HAL_GPIOI.h" 2


# 1 "MCAL_layer/GPIO_1/hal_gpio_cfg.h" 1
# 16 "MCAL_layer/GPIO_1/HAL_GPIOI.h" 2
# 30 "MCAL_layer/GPIO_1/HAL_GPIOI.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
switch(_pin_config->direction){
    case OUTPUT:
        (*tris_register[_pin_config->port] &= ~(1<<_pin_config->pin));
        break;
    case INPUT:
        (*tris_register[_pin_config->port] |= (1<<_pin_config->pin));
        break;
...
std_returntype gpio_pin_direction_statuse(const pin_config_t *_pin_config,direction_t *dir_statuse){
std_returntype RET = (std_returntype)0x01;
if(((void*)0)==_pin_config||((void*)0)==dir_statuse|| _pin_config->pin > 8 -1){
    RET= (std_returntype)0x00;
}else{
*dir_statuse=((*tris_register[_pin_config->port] >> _pin_config->pin) & (uint8)1);
}
return RET;
}
...
if(((void*)0)==_pin_config||_pin_config->pin > 8 -1){
    ...
    switch(logic){
        case LOW:
            (*lat_register[_pin_config->port] &= ~(1<<_pin_config->pin));
            break;
        case HIGH:
            (*lat_register[_pin_config->port] |= (1<<_pin_config->pin));
            break;
...
std_returntype gpio_port_get_direction_statuse(PORT_index_t port,uint8 *dir_statuse){
std_returntype RET = (std_returntype)0x01;
if(((void*)0)==dir_statuse||port>5 -1){
    RET= (std_returntype)0x00;
}else{
    *dir_statuse=*tris_register[port];
}
